    ...
    <main>
      ...
      <section className="relative h-[409px] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-margin-mobile">
          <h1 className="font-display-lg text-display-lg text-surface mb-4">Get in Touch</h1>
          <p className="font-body-lg text-body-lg text-surface/90 max-w-2xl mx-auto">Connecting our global academic community. Whether you're an applicant, parent, or partner, our team is here to assist you.</p>
        </div>
      </section>
      ...
      <section className="max-w-container-max mx-auto px-margin-desktop py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
          ...
          <div className="lg:col-span-5 space-y-gutter">
            <div className="bg-surface-container-lowest p-8 border border-on-surface/10 rounded-lg shadow-sm">
              <div className="flex items-center gap-4 mb-6">
                <span className="material-symbols-outlined text-primary p-3 bg-surface rounded-full">location_on</span>
                <h3 className="font-headline-sm text-headline-sm text-primary">Our Campus</h3>
              </div>
            ...
            <div className="bg-surface-container-lowest p-8 border border-on-surface/10 rounded-lg shadow-sm">
              <div className="flex items-center gap-4 mb-6">
                <span className="material-symbols-outlined text-primary p-3 bg-surface rounded-full">call</span>
                <h3 className="font-headline-sm text-headline-sm text-primary">Direct Contact</h3>
              </div>
              <div className="space-y-4">
                <div>
                  <p className="font-label-md text-label-md uppercase tracking-wider text-on-surface-variant opacity-60">Admissions &amp; Admin</p>
                  <p className="font-body-lg text-body-lg font-semibold text-primary underline decoration-tertiary underline-offset-4">admin@noorulilm.edu</p>
          ...
          <div className="lg:col-span-7 bg-surface-container-lowest p-10 border border-on-surface/10 rounded-lg shadow-sm">
            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              ...
              <button disabled={buttonState !== 'idle'} className={`w-full md:w-auto px-12 py-4 rounded-lg font-label-lg transition-all duration-300 transform active:scale-95 shadow-lg shadow-tertiary/20 ${buttonState === 'sent' ? 'bg-green-600 text-white' : 'bg-tertiary text-on-surface hover:bg-primary hover:text-surface'}`} type="submit">
      ...
      <section className="w-full h-[600px] relative bg-surface-container-high overflow-hidden">
        ...
        <div className="absolute bottom-12 left-12 p-6 bg-surface/90 backdrop-blur-md border border-on-surface/10 rounded-lg shadow-2xl max-w-sm hidden md:block">
          <h4 className="font-headline-sm text-headline-sm text-primary mb-2">Visit Our Campus</h4>
          ...
          <a className="flex items-center text-primary font-label-lg gap-2 hover:translate-x-2 transition-transform" href="#">
            GET DIRECTIONS
      ...
      {/* FAQ CTA Section */}
      <section className="bg-primary text-surface py-20 px-margin-mobile">
        <div className="max-w-container-max mx-auto text-center">
          <h2 className="font-headline-lg text-headline-lg mb-6">Need Immediate Answers?</h2>
          <p className="font-body-lg text-body-lg text-surface/80 mb-10 max-w-xl mx-auto">Browse our frequently asked questions about admissions, fees, and campus life before reaching out.</p>
          <Link to="/admissions" className="inline-block border-2 border-tertiary text-tertiary px-10 py-3 rounded font-label-lg hover:bg-tertiary hover:text-primary transition-all">
            VISIT HELP CENTER
          </Link>
        </div>
      </section>
